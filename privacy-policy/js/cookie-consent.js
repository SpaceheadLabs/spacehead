(function () {
  ...
  var DISMISSED_COOKIE = 'ACCEPTCONSENT';

  // The path to built in themes (s3 bucket)
  var THEME_BUCKET_PATH = 'https://www.spacehead.com/privacy-policy/css/';
  ...
  var cookieconsent = {
    options: {
      ...
      link: 'https://www.spacehead.com/privacy-policy/',
    ...
    setDismissedCookie: function () {
      Util.setCookie(DISMISSED_COOKIE, 'y', this.options.expiryDays, this.options.domain, this.options.path);
    }
  };
